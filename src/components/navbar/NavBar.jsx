    ...
    return (
            <div className="navbar">
                <ul className="navbar-list">
                    <li>
                        <NavLink className="navbar-item" to={"/"} activeClassName="active" onClick={() => handlePathChange('/')}>
                    ...
                    <li>
                        <NavLink className="navbar-item" to={"/about"} activeClassName="active" onClick={() => handlePathChange('/about')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentcolor"
                    ...
                    <li>
                        <NavLink className="navbar-item" to={"/skills"} activeClassName="active" onClick={() => handlePathChange('/skills')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentcolor"
                    ...
                    <li>
                        <NavLink className="navbar-item" to={"/projects"} activeClassName="active" onClick={() => handlePathChange('/projects')} >
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentcolor"
                    ...
                    <li>
                        <NavLink className="navbar-item" to={"/experiences"} activeClassName="active" onClick={() => handlePathChange('/experiences')}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentcolor"
